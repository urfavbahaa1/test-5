...
function OfficeStyles() {
  return (
    <style>{`
      ...
      .dashboard-ambient .cl-dark-overlay{
        position:absolute; inset:0; background:#050505;
        opacity:var(--dark-op, 1);
      }
      ...
      .dashboard-ambient .cl-headlight-glow{
        position:absolute; transform:translate(-50%,-50%); border-radius:50%;
        background:radial-gradient(ellipse at center, rgba(255,255,255,0.95) 0%, rgba(255,255,255,0.45) 32%, rgba(255,255,255,0) 72%);
        opacity:var(--glow-op, 0); filter:blur(4px); mix-blend-mode:screen;
      }
      .dashboard-ambient .cl-hazard-glow{
        position:absolute; transform:translate(-50%,-50%); border-radius:50%;
        background:radial-gradient(ellipse at center, rgba(255,176,64,0.95) 0%, rgba(255,146,40,0.55) 38%, rgba(255,146,40,0) 74%);
        opacity:0; filter:blur(3px); mix-blend-mode:screen;
      }
      .dashboard-ambient.hazard-on .cl-hazard-glow{
        animation:clHazardPulse 2.1s ease-in-out infinite;
      }
      @keyframes clHazardPulse{
        0%, 58%, 100%{ opacity:0; }
        10%{ opacity:0.8; }
        22%{ opacity:1; }
        36%{ opacity:0.85; }
      ...
      @media (prefers-reduced-motion: reduce){
        ...
        .dashboard-ambient.hazard-on .cl-hazard-glow{ animation:none; opacity:0.6; }
      }
